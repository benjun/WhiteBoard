...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'whiteboard.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'whiteboard.UserRole'
grails.plugin.springsecurity.authority.className = 'whiteboard.Role'
